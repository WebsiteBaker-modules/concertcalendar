...
// Update row
$database->query("UPDATE `".TABLE_PREFIX."mod_concert_dates` SET `page_id` = '$page_id', `section_id` = '$section_id', `concert_date` = '$date', `concert_desc` = '$concert_desc', `concert_name` = '$concert_name', `concert_place` = '$concert_place', `concert_club` = '$concert_club', `concert_price` = '$concert_price', `concert_time` = '$concert_time' WHERE `concert_id` = '$concert_id'");
